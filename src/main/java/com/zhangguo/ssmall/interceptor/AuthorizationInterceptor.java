package com.zhangguo.ssmall.interceptor;
...
public class AuthorizationInterceptor  implements HandlerInterceptor {
	...
	private static final String[] IGNORE_URI = {"/loginFormBook", "/loginBook"};
        ...
        if (!flag){
        	...
        	if(user == null){
        		// 如果用户没有登录，则设置提示信息，跳转到登录页面
        		 ...
        		 request.getRequestDispatcher("loginFormBook").forward(request, response);
        	}else{
        		// 如果用户已经登录，则验证通过，放行
